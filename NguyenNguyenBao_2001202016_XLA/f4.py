...
class ImageSelector(tk.Frame):
    ...
    def create_widgets(self):
        ...
        # self.canvas = tk.Canvas(self, width=480, height=480, background="light gray")
        ...
        # self.canvas2 = tk.Canvas(self, width=480, height=480, background="light gray")
    ...
    def on_select_combo1(self, event):
