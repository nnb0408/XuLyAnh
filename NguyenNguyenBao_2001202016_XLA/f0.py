...
class ImageSelector(tk.Frame):
    ...
    def create_widgets(self):
        self.label0 = tk.Label(self, text="2001202290 - Lê Bùi Tấn Trưởng - Đồ án Thực hành Xử lý Ảnh", font=("Arial Bold", 18), fg = 'red')
        ...
        self.label1 = tk.Label(self, text="Ảnh Gốc", font="VNI-Dom 11")
        self.label1.place(x=222,y=110)
        self.label2 = tk.Label(self, text="Ảnh đã Biến đổi", font="VNI-Dom 11")
        self.label2.place(x=740,y=110)
        ...
        self.canvas2 = tk.Canvas(self, width=500, height=500)
